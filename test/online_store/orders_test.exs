defmodule OnlineStore.OrdersTest do
  use OnlineStore.DataCase

  alias OnlineStore.Orders

  describe "orders" do
    alias OnlineStore.Orders.Order

    import OnlineStore.OrdersFixtures
  ...
  describe "order_line_items" do
    alias OnlineStore.Orders.LineItem
