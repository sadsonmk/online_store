defmodule OnlineStore.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `OnlineStore.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> OnlineStore.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> OnlineStore.ShoppingCart.create_cart_item()
